...
using dtype_bfloat16 = hip_bfloat16;
...
using dtype_fp8_e4m3 = __nv_fp8_e4m3;
using dtype_fp8_e5m2 = __nv_fp8_e5m2;
#endif
...
inline void check_shape(const at::Tensor &a,
                        const at::Tensor &b,
                        const char *a_name,
                        const char *b_name)
{
    ...
    for (int i = 0; i < a.dim(); ++i) {
        TORCH_CHECK(a.size(i) == b.size(i), a_name, ".size(", i,
                    ") != ", b_name, ".size(", i, ")");
    }
}
