...
// void bmm_fp8(at::Tensor A, at::Tensor B, at::Tensor D, at::Tensor A_scale,
// at::Tensor B_scale,
//              at::Tensor workspace_buffer, int64_t cublas_handle);

// void CutlassSegmentGEMM(at::Tensor workspace_buffer, at::Tensor all_problems,
// at::Tensor x_ptr,
//                         at::Tensor w_ptr, at::Tensor y_ptr, at::Tensor x_ld,
//                         at::Tensor w_ld, at::Tensor y_ld, at::Tensor
...
//     at::Tensor o_p, std::optional<at::Tensor> maybe_lse_p, int64_t
//     mask_mode_code_p, int64_t layout_p, int64_t window_left_p,
//     std::optional<at::Tensor> maybe_custom_mask_p, std::optional<at::Tensor>
//     maybe_alibi_slopes_p, double logits_soft_cap_p, double sm_scale_p, double
//     rope_rcp_scale_p, double rope_rcp_theta_p,
//     // Decode params
...
//     at::Tensor paged_v_cache_d, at::Tensor qo_indptr_d, at::Tensor
//     paged_kv_indptr_d, at::Tensor paged_kv_indices_d, at::Tensor
//     paged_kv_last_page_len_d, at::Tensor o_d, std::optional<at::Tensor>
//     maybe_lse_d, int64_t mask_mode_code_d, int64_t layout_d, int64_t
//     window_left, std::optional<at::Tensor> maybe_custom_mask_d,
//     std::optional<at::Tensor> maybe_mask_indptr_d, std::optional<at::Tensor>
//     maybe_alibi_slopes_d, double logits_soft_cap_d, double sm_scale_d, double
//     rope_rcp_scale_d, double rope_rcp_theta_d);
//========== quantization ==========

// void packbits(at::Tensor x, const std::string& bitorder, at::Tensor y);

// void segment_packbits(at::Tensor x, at::Tensor input_indptr, at::Tensor
// output_indptr,
...
void sampling_from_probs(at::Tensor probs,
                         at::Tensor output,
                         std::optional<at::Tensor> maybe_indices,
                         bool deterministic,
                         std::optional<at::Generator> gen);

void top_p_sampling_from_probs(at::Tensor probs,
                               at::Tensor output,
                               std::optional<at::Tensor> maybe_indices,
...
void top_k_sampling_from_probs(at::Tensor probs,
                               at::Tensor output,
                               std::optional<at::Tensor> maybe_indices,
...
void min_p_sampling_from_probs(at::Tensor probs,
                               at::Tensor output,
                               std::optional<at::Tensor> maybe_indices,
...
void top_k_mask_logits(at::Tensor logits,
                       at::Tensor mask_logits,
                       std::optional<at::Tensor> maybe_top_k_arr,
                       int64_t top_k_val);
